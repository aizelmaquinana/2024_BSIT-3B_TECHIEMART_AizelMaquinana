...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    // Construct SQL query
    $sql = "INSERT INTO users (first_name, last_name, username, password, email, contact_num, address) VALUES ('$first_name', '$last_name', '$username', '$password', '$email', '$contact_num', '$address')";
